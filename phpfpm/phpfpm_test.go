...
// https://github.com/jensschulze/php-fpm_exporter/issues/10
...
// https://github.com/jensschulze/php-fpm_exporter/issues/24
func TestInvalidCharacterIssue24(t *testing.T) { //revive:disable-line:unused-parameter
